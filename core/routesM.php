<?php
	...
	function cargarControladorin($controlador){
		...
		if(!is_file($archivoControlador)){
			...
			$archivoControlador= 'controllers/'.CONTROLADOR_PRINCIPALIN.'.php';
	...
	function cargarAccionin($controller, $accion, $id = null){
