<?php
	...
	function enviarEmail($email, $nombre, $asunto, $cuerpo){
		...
		require_once 'PHPMailer1/PHPMailerAutoload.php';
		...
		$mail->Username = 'inventoryweb77@gmail.com'; //Modificar
		$mail->Password = 'johanywilliam'; //Modificar
		
		$mail->setFrom($email, $nombre); //Modificar
	...
	function cambiaPassword($password, $user_id, $token){
		...
		$stmt = $mysqli->prepare("UPDATE usuarios SET Contrasena = ?, token_password='', password_request=0 WHERE idUsuario = ? AND token_password = ?");
